...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/outil-accessibilite-web`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
    { url: `${SITE_URL}/scanner-accessibilite-rgaa`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
